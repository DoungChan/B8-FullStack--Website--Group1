...
const PromotionCard = ({ promotion, postPromo = false }) => {
  ...
  const onDeletePromotion = () => {
    ...
    callApi(`/posted_promotion/delete?promotionId=${promotion.id}`, "DELETE").then((res) => {
      if (res.status === 200) { 
        closeModal();
      ...
      <div>
        ...
        >
          <div className="flex justify-center items-center">
            <Image src="/icon_images/trash_icon.png" width={150} height={150} alt="Trash" />
          </div>
          <div className="flex items-center justify-center"><h4 className="font-bold">Are you sure you want to <br />delete your promotion?</h4></div>
        ...
        <div className="w-[302px] h-[298px] duration-700 rounded-lg items-center justify-center overflow-hidden transition ease-in-out hover:scale-110"
          ...
          <div className="py-2 px-2">
            ...
            <div className="flex items-center">
              <p className="mr-2 line-through text-font_color">${promotion.old_price}
              </p>
